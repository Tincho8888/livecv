  ...
  return (
    <div className="auth-modal-overlay" onClick={onClose}>
      <div className="auth-modal" onClick={e => e.stopPropagation()}>
        <div className="auth-logo">LIVE<span className="sub">CV</span></div>
        <div className="auth-title">Bienvenido</div>
        <div className="auth-sub">
          Iniciá sesión para guardar tus CVs, acceder desde cualquier dispositivo y compartirlos en vivo.
        </div>
        <button
